...
2. cbind, coercion all objects into DDF. Do not need to define coercion of DDF to dDF with no-op because as() does not do the correct thing. 
still need is(x,"DDF") to check if DDF. 
DataFrame: c -- cbind -- DataFrame()
DDF: c -- cbind -- .cbindDDF   -- done!
DDF() -- cbind -- done!
checkings?? cbind to make sure all DDF objects to have same nrows. otherwise, iterate atomic ... 
